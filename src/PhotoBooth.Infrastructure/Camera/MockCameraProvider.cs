...
{
    private readonly byte[] _mockImageData;
    ...
    public MockCameraProvider(
        ...
        byte[]? mockImageData = null,
        TimeSpan? captureLatency = null)
    {
        _isAvailable = isAvailable;
        _mockImageData = mockImageData ?? GenerateMockJpeg();
        CaptureLatency = captureLatency ?? TimeSpan.Zero;
    }
    ...
    {
        return Task.FromResult(_mockImageData);
    }

    private static byte[] GenerateMockJpeg()
    {
